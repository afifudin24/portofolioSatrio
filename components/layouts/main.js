...
import charactercat from "../../public/character/cat.json";
import server from "../../public/character/server.json";
  ...
  return (
    <Box as="main" pb={8}>
      <Head>
        ...
        <title>Satrio Janara Arafa</title>
      </Head>
      ...
      <Container maxW="container.md" pt={'10'}>
        ...
        <Lottie animationData={server} loop={true} style={{ height: 100, background: 'transparent' }} />
